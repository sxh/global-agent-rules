...
# --- 5. (retired) vendored-patch markers ---
# plugins/pcp.ts was forked from pcp-skills on 2026-09-18 and is now owned here; there is no
# upstream re-download to guard against, so the PCP_*_FIX marker check was removed. See
# docs/pcp-recovery.md ("Ownership").
